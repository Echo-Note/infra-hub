...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="notice",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="notifications.messagecontent", verbose_name="Notice"
            ),
        ),
        migrations.AddField(
            model_name="messageuserread",
        ...
        migrations.AddField(
            ...
            name="users",
            field=models.ManyToManyField(
                related_name="system_msg_subscriptions", to=settings.AUTH_USER_MODEL, verbose_name="User"
            ),
        ),
        migrations.AddField(
