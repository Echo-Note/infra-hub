    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "avatar",
                    apps.common.fields.image.ProcessedImageField(
                        blank=True,
                        null=True,
                ...
                (
                    "gender",
                    models.IntegerField(
                        choices=[(0, "Unknown"), (1, "Male"), (2, "Female")], default=0, verbose_name="Gender"
                    ),
                ),
            ...
            bases=(apps.common.core.models.AutoCleanFileMixin, models.Model),
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "menu_type",
                    models.SmallIntegerField(
                        choices=[(0, "Directory"), (1, "Menu"), (2, "Permission")], default=0, verbose_name="Menu type"
                    ),
                ),
                (
                    "name",
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, to="system.menumeta", verbose_name="Menu meta"
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "field_type",
                    models.SmallIntegerField(
                        choices=[(0, "Role permission"), (1, "Data permission")], default=1, verbose_name="Field type"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("request_uuid", models.UUIDField(blank=True, null=True, verbose_name="Request ID")),
                ("exec_time", models.FloatField(blank=True, null=True, verbose_name="Execution time")),
                (
                    "creator",
                    models.ForeignKey(
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "inherit",
                    models.BooleanField(
                        default=False, help_text="Allows users to inherit this config", verbose_name="User inherit"
                    ),
                ),
                (
                    "creator",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("channel_name", models.CharField(blank=True, max_length=128, null=True, verbose_name="Channel name")),
                (
                    "login_type",
                    models.SmallIntegerField(
                        choices=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "menu",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="system.menu", verbose_name="Menu"
                    ),
                ),
                ...
                (
                    "role",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="system.userrole", verbose_name="Role"
                    ),
                ),
            ],
            options={
